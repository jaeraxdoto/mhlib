...
public:
	 ...
	 * a base class. */
    virtual mh_bare_solution & operator = (const mh_bare_solution &orig) = delete;
	...
	/** Creates an uninitialized object of the same class as the
		...
		template object. */
	virtual mh_bare_solution *createUninitialized() const=0;
	...
	virtual mh_bare_solution *clone() const
		{ mh_bare_solution *p=createUninitialized();
...
inline std::ostream &operator<<(std::ostream &ostr, mh_bare_solution &sol) {
